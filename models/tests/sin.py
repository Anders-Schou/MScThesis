...
class Sin1DPINN(PINN):
    ...
    def loss_terms(self,
        ...
        if update_key == 0:
            loss = self.loss0(params, inputs["coll"], true_val=true_val["0"])
            # bcloss = self.loss2(params, inputs["bc"], true_val=true_val["bc2"])
            # return jnp.array((loss, bcloss))
            return jnp.array(loss)

        if update_key == 1:
            loss1 = self.loss1(params, inputs["coll"], true_val=true_val["1"])
            # bcloss0 = self.loss0(params, inputs["bc"], true_val=true_val["bc0"])
            # return jnp.array((loss1, bcloss0))
            return jnp.array(loss1)
        
        if update_key == 2:
            loss2 = self.loss2(params, inputs["coll"], true_val=true_val["2"])
            bcloss0 = self.loss0(params, inputs["bc"], true_val=true_val["bc0"])
            bcloss1 = self.loss1(params, inputs["bc"], true_val=true_val["bc1"])
            return jnp.array((loss2, bcloss1, bcloss0))

        if update_key == 3:
            loss3 = self.loss3(params, inputs["coll"], true_val=true_val["3"])
            bcloss0 = self.loss0(params, inputs["bc"], true_val=true_val["bc0"])
            bcloss1 = self.loss1(params, inputs["bc"], true_val=true_val["bc1"])
            bcloss2 = self.loss2(params, inputs["bc"], true_val=true_val["bc2"])
            return jnp.array((loss3, bcloss2, bcloss1, bcloss0))

        if update_key == 4:
            loss4 = self.loss4(params, inputs["coll"], true_val=true_val["4"])
            # bcloss0 = self.loss0(params, inputs["bc"], true_val=true_val["bc0"])
            # bcloss1 = self.loss1(params, inputs["bc"], true_val=true_val["bc1"])
            bcloss2 = self.loss2(params, inputs["bc"], true_val=true_val["bc2"])
        ...
        loss0 = self.loss0(params, inputs["coll"], true_val=true_val["0"])
        loss1 = self.loss1(params, inputs["coll"], true_val=true_val["1"])
        loss2 = self.loss2(params, inputs["coll"], true_val=true_val["2"])
        loss3 = self.loss3(params, inputs["coll"], true_val=true_val["3"])
        loss4 = self.loss4(params, inputs["coll"], true_val=true_val["4"])
