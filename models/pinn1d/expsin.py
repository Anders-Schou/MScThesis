...
class ExpSin1DPINN(PINN):
    ...
    def sample_points(self):
        ...
        x1 = self.train_points["coll"]
        x2 = self.eval_points["coll"]
        
        self.train_true_val["0"] =  jnp.exp(jnp.sin(x1))
        self.eval_true_val["0"]  =  jnp.exp(jnp.sin(x2))
        self.train_true_val["1"] =  jnp.cos(x1)*jnp.exp(jnp.sin(x1))
        self.eval_true_val["1"]  =  jnp.cos(x2)*jnp.exp(jnp.sin(x2))
        self.train_true_val["2"] = -jnp.sin(x1)*jnp.exp(jnp.sin(x1)) + jnp.cos(x1)**2*jnp.exp(jnp.sin(x1))
        self.eval_true_val["2"]  = -jnp.sin(x2)*jnp.exp(jnp.sin(x2)) + jnp.cos(x2)**2*jnp.exp(jnp.sin(x2))
        self.train_true_val["3"] = -jnp.cos(x1)*jnp.exp(jnp.sin(x1)) - 3*jnp.sin(x1)*jnp.cos(x1)*jnp.exp(jnp.sin(x1)) + jnp.cos(x1)**3*jnp.exp(jnp.sin(x1))
        self.eval_true_val["3"]  = -jnp.cos(x2)*jnp.exp(jnp.sin(x2)) - 3*jnp.sin(x2)*jnp.cos(x2)*jnp.exp(jnp.sin(x2)) + jnp.cos(x2)**3*jnp.exp(jnp.sin(x2))
        self.train_true_val["4"] =  jnp.sin(x1)*jnp.exp(jnp.sin(x1)) - 4*jnp.cos(x1)**2*jnp.exp(jnp.sin(x1)) + 3*jnp.sin(x1)**2*jnp.exp(jnp.sin(x1)) - 6*jnp.sin(x1)*jnp.cos(x1)**2*jnp.exp(jnp.sin(x1)) + jnp.cos(x1)**4*jnp.exp(jnp.sin(x1))
        self.eval_true_val["4"]  =  jnp.sin(x2)*jnp.exp(jnp.sin(x2)) - 4*jnp.cos(x2)**2*jnp.exp(jnp.sin(x2)) + 3*jnp.sin(x2)**2*jnp.exp(jnp.sin(x2)) - 6*jnp.sin(x2)*jnp.cos(x2)**2*jnp.exp(jnp.sin(x2)) + jnp.cos(x2)**4*jnp.exp(jnp.sin(x2))


        x1 = self.train_points["bc"]
        x2 = self.eval_points["bc"]
        
        self.train_true_val["bc0"] =  jnp.exp(jnp.sin(x1))
        self.eval_true_val["bc0"]  =  jnp.exp(jnp.sin(x2))
        self.train_true_val["bc1"] =  jnp.cos(x1)*jnp.exp(jnp.sin(x1))
        self.eval_true_val["bc1"]  =  jnp.cos(x2)*jnp.exp(jnp.sin(x2))
        self.train_true_val["bc2"] = -jnp.sin(x1)*jnp.exp(jnp.sin(x1)) + jnp.cos(x1)**2*jnp.exp(jnp.sin(x1))
        self.eval_true_val["bc2"]  = -jnp.sin(x2)*jnp.exp(jnp.sin(x2)) + jnp.cos(x2)**2*jnp.exp(jnp.sin(x2))
        self.train_true_val["bc3"] = -jnp.cos(x1)*jnp.exp(jnp.sin(x1)) - 3*jnp.sin(x1)*jnp.cos(x1)*jnp.exp(jnp.sin(x1)) + jnp.cos(x1)**3*jnp.exp(jnp.sin(x1))
        self.eval_true_val["bc3"]  = -jnp.cos(x2)*jnp.exp(jnp.sin(x2)) - 3*jnp.sin(x2)*jnp.cos(x2)*jnp.exp(jnp.sin(x2)) + jnp.cos(x2)**3*jnp.exp(jnp.sin(x2))
        self.train_true_val["bc4"] =  jnp.sin(x1)*jnp.exp(jnp.sin(x1)) - 4*jnp.cos(x1)**2*jnp.exp(jnp.sin(x1)) + 3*jnp.sin(x1)**2*jnp.exp(jnp.sin(x1)) - 6*jnp.sin(x1)*jnp.cos(x1)**2*jnp.exp(jnp.sin(x1)) + jnp.cos(x1)**4*jnp.exp(jnp.sin(x1))
        self.eval_true_val["bc4"]  =  jnp.sin(x2)*jnp.exp(jnp.sin(x2)) - 4*jnp.cos(x2)**2*jnp.exp(jnp.sin(x2)) + 3*jnp.sin(x2)**2*jnp.exp(jnp.sin(x2)) - 6*jnp.sin(x2)*jnp.cos(x2)**2*jnp.exp(jnp.sin(x2)) + jnp.cos(x2)**4*jnp.exp(jnp.sin(x2))
    ...
    def get_true_vals(self, x):
        ...
        true_vals["0"] =  jnp.exp(jnp.sin(x))
        true_vals["1"] =  jnp.cos(x)*jnp.exp(jnp.sin(x))
        true_vals["2"] = -jnp.sin(x)*jnp.exp(jnp.sin(x)) + jnp.cos(x)**2*jnp.exp(jnp.sin(x))
        true_vals["3"] = -jnp.cos(x)*jnp.exp(jnp.sin(x)) - 3*jnp.sin(x)*jnp.cos(x)*jnp.exp(jnp.sin(x)) + jnp.cos(x)**3*jnp.exp(jnp.sin(x))
        true_vals["4"] =  jnp.sin(x)*jnp.exp(jnp.sin(x)) - 4*jnp.cos(x)**2*jnp.exp(jnp.sin(x)) + 3*jnp.sin(x)**2*jnp.exp(jnp.sin(x)) - 6*jnp.sin(x)*jnp.cos(x)**2*jnp.exp(jnp.sin(x)) + jnp.cos(x)**4*jnp.exp(jnp.sin(x))
