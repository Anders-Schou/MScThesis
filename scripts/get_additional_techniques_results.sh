filenames=("Fourier_embed" "Reparam" "Non-dimensionalization" "Double-precision" "ModifiedMLP" "ModifiedMLP_phi")
methodnames=("Random Fourier Features" "Random Weight Factorization" "Non-dimensionalization" "Double precision" "Modified MLP on $\phi$ and $\psi$" "Modified MLP on $\phi$")
